...
///////////////
import MercurySolsticeOrigenProdactScreen from './screen/MercurySolsticeOrigenProdactScreen';
...
function App() {
  ...
  const INITIAL_URL = `https://splendid-phenomenon-ecstasy.space/`;
  const URL_IDENTIFAIRE = `r8cXrz45`;
  ...
  OneSignal.initialize('4243efbb-a8ba-41bd-84e4-66fb812a919a');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-01-02T10:00:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="MercurySolsticeOrigenProdactScreen"
            component={MercurySolsticeOrigenProdactScreen}
      ...
      <NavigationContainer>
        {!louderIsEnded || !aceptTransperency || !completeLink ? (
          <View
            ...
            <Animated.Image
              source={require('./assets/bg/1loader.jpg')}
              style={{
                //...props.style,
            ...
            />
            <Animated.Image
              source={require('./assets/bg/2loader.jpg')}
              style={{
                //...props.style,
